      ...
      try
      {
        ...
        switch (statProperties[1])
        {
          case "c":
            ...
            {
              // gorets:1|c|@0.1
              return new Counter(nameAndValue[0], Double.Parse(statProperties[0], CultureInfo.InvariantCulture), float.Parse(statProperties[2].Remove(0, 1), CultureInfo.InvariantCulture));
            }
          case "ms":
            // glork:320|ms
